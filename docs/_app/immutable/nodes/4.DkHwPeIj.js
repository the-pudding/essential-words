import"../chunks/DsnmJJEf.js";import{al as b,$ as f,a1 as C,a0 as p,t as M,K as c,an as F,Z,ag as J,_ as K,ad as ie,M as R,aE as ke,am as P,ba as Se,L as Ae}from"../chunks/BouHPhyx.js";import{b as h,f as _,c as D,t as Ce}from"../chunks/CjYGnkC0.js";import{a as E,f as xe,e as de}from"../chunks/BA0teXdn.js";import{e as U,i as N,b as Ie,s as ue,c as Ee,d as De}from"../chunks/BJ9YyB53.js";import{e as oe}from"../chunks/CPwCmilQ.js";import{c as se}from"../chunks/BYrJ3R8_.js";import{s as re,p as q}from"../chunks/BedyKmqI.js";import{s as me}from"../chunks/Bnz2TgY4.js";import{b as Me,i as ee}from"../chunks/Rb_QLIf0.js";import{c as Oe}from"../chunks/BhI2WhGu.js";import{h as z}from"../chunks/BIxuo7In.js";import{b as Be}from"../chunks/DS1APBp1.js";import"../chunks/tGppMfpQ.js";var he={},te={},ae=34,Y=10,ne=13;function ge(n){return new Function("d","return {"+n.map(function(e,t){return JSON.stringify(e)+": d["+t+'] || ""'}).join(",")+"}")}function Le(n,e){var t=ge(n);return function(o,s){return e(t(o),s,n)}}function pe(n){var e=Object.create(null),t=[];return n.forEach(function(o){for(var s in o)s in e||t.push(e[s]=s)}),t}function I(n,e){var t=n+"",o=t.length;return o<e?new Array(e-o+1).join(0)+t:t}function je(n){return n<0?"-"+I(-n,6):n>9999?"+"+I(n,6):I(n,4)}function qe(n){var e=n.getUTCHours(),t=n.getUTCMinutes(),o=n.getUTCSeconds(),s=n.getUTCMilliseconds();return isNaN(n)?"Invalid Date":je(n.getUTCFullYear())+"-"+I(n.getUTCMonth()+1,2)+"-"+I(n.getUTCDate(),2)+(s?"T"+I(e,2)+":"+I(t,2)+":"+I(o,2)+"."+I(s,3)+"Z":o?"T"+I(e,2)+":"+I(t,2)+":"+I(o,2)+"Z":t||e?"T"+I(e,2)+":"+I(t,2)+"Z":"")}function Fe(n){var e=new RegExp('["'+n+`
\r]`),t=n.charCodeAt(0);function o(a,d){var T,w,m=s(a,function(A,v){if(T)return T(A,v-1);w=A,T=d?Le(A,d):ge(A)});return m.columns=w||[],m}function s(a,d){var T=[],w=a.length,m=0,A=0,v,k=w<=0,S=!1;a.charCodeAt(w-1)===Y&&--w,a.charCodeAt(w-1)===ne&&--w;function j(){if(k)return te;if(S)return S=!1,he;var G,W=m,x;if(a.charCodeAt(W)===ae){for(;m++<w&&a.charCodeAt(m)!==ae||a.charCodeAt(++m)===ae;);return(G=m)>=w?k=!0:(x=a.charCodeAt(m++))===Y?S=!0:x===ne&&(S=!0,a.charCodeAt(m)===Y&&++m),a.slice(W+1,G-1).replace(/""/g,'"')}for(;m<w;){if((x=a.charCodeAt(G=m++))===Y)S=!0;else if(x===ne)S=!0,a.charCodeAt(m)===Y&&++m;else if(x!==t)continue;return a.slice(W,G)}return k=!0,a.slice(W,w)}for(;(v=j())!==te;){for(var L=[];v!==he&&v!==te;)L.push(v),v=j();d&&(L=d(L,A++))==null||T.push(L)}return T}function r(a,d){return a.map(function(T){return d.map(function(w){return i(T[w])}).join(n)})}function u(a,d){return d==null&&(d=pe(a)),[d.map(i).join(n)].concat(r(a,d)).join(`
`)}function g(a,d){return d==null&&(d=pe(a)),r(a,d).join(`
`)}function y(a){return a.map(l).join(`
`)}function l(a){return a.map(i).join(n)}function i(a){return a==null?"":a instanceof Date?qe(a):e.test(a+="")?'"'+a.replace(/"/g,'""')+'"':a}return{parse:o,parseRows:s,format:u,formatBody:g,formatRows:y,formatRow:l,formatValue:i}}var Re=Fe(","),Ue=Re.parse,Ne=_('<section id="demo-link"><h2>Link</h2> <p><a href="elements">Default element styles demo</a></p> <p><a href="fonts">Pudding-hosted font previews</a></p> <p><a href="ui">BitsUI styled components</a></p></section>');function He(n){var e=Ne();h(n,e)}var Pe=_('<section id="demo-image"><h2>Image</h2> <p>img tag</p> <img src="../assets/demo/test.jpg" alt="cat" class="svelte-b56t42"/> <p>background image</p> <div class="svelte-b56t42"></div></section>');function Ge(n){var e=Pe();h(n,e)}var We=_('<section id="demo-element"><h2>Dynamic Svelte Element</h2> <!></section>');function ze(n){const e=[{tag:"h3",text:"I am a h3 tag."},{tag:"p",text:"I am p tag."}];var t=We(),o=b(f(t),2);U(o,17,()=>e,N,(s,r)=>{let u=()=>c(r).tag,g=()=>c(r).text;var y=D(),l=C(y);oe(l,u,!1,(i,a)=>{var d=Ce();M(()=>E(d,g())),h(a,d)}),h(s,y)}),p(t),h(n,t)}var Ve=_("<p> </p>");function Ye(n,e){var t=Ve(),o=f(t);p(t),M(()=>E(o,`I am component A and my favorite number is ${e.number??""}.`)),h(n,t)}var Je=_("<p> </p>");function Ze(n,e){var t=Je(),o=f(t);p(t),M(()=>E(o,`I am component B and my name is ${e.name??""}.`)),h(n,t)}var Ke=_('<section id="demo-component"><h2>Dynamic Svelte Component</h2> <!></section>');function Qe(n){const e={A:Ye,B:Ze},t=[{component:"A",number:42},{component:"B",name:"Russell"}];var o=Ke(),s=b(f(o),2);U(s,17,()=>t,N,(r,u)=>{const g=F(()=>e[c(u).component]);var y=D(),l=C(y);se(l,()=>c(g),(i,a)=>{a(i,re(()=>c(u)))}),h(r,y)}),p(o),h(n,o)}var Xe=_("<div><!></div>");function $e(n,e){Z(e,!0);let t=q(e,"root",3,null),o=q(e,"top",3,0),s=q(e,"bottom",3,0),r=q(e,"increments",3,100),u=q(e,"value",15,void 0),g=[],y=[],l=[],i=[],a;function d(){let v=0,k=0;for(let S=0;S<g.length;S++)g[S]>v&&(v=g[S],k=S);v>0?u(k):u(void 0)}function T(v,k){const S=H=>{H[0].isIntersecting;const Q=H[0].intersectionRatio;g[k]=Q,d()},j=o()?o()*-1:0,L=s()?s()*-1:0,G=`${j}px 0px ${L}px 0px`,W={root:t(),rootMargin:G,threshold:y};i[k]&&i[k].disconnect();const x=new IntersectionObserver(S,W);x.observe(v),i[k]=x}function w(){l.length&&l.forEach(T)}J(()=>{for(let v=0;v<r()+1;v++)y.push(v/r());l=a.querySelectorAll(":scope > *:not(iframe)"),w()}),J(()=>{o(),s(),w()});var m=Xe(),A=f(m);me(A,()=>e.children??ie),p(m),Me(m,v=>a=v,()=>a),h(n,m),K()}var et=_('<div><p class="svelte-1sxgmm9"> </p></div>'),tt=_('<section id="scrolly"><h2 class="svelte-1sxgmm9">Scrolly <span> </span></h2> <div class="spacer svelte-1sxgmm9"></div> <!> <div class="spacer svelte-1sxgmm9"></div></section>');function at(n){let e=P(void 0);var t=tt(),o=f(t),s=b(f(o)),r=f(s,!0);p(s),p(o);var u=b(o,4);$e(u,{get value(){return c(e)},set value(g){R(e,g,!0)},children:(g,y)=>{var l=D(),i=C(l);U(i,16,()=>[0,1,2,3,4],N,(a,d,T)=>{const w=F(()=>c(e)===T);var m=et();let A;var v=f(m),k=f(v,!0);p(v),p(m),M(()=>{A=Ie(m,1,"step svelte-1sxgmm9",null,A,{active:c(w)}),E(k,d)}),h(a,m)}),h(g,l)},$$slots:{default:!0}}),ke(2),p(t),M(()=>E(r,c(e)||"-")),h(n,t)}const nt=`{
  "meta": {
