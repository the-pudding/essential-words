import"../chunks/DsnmJJEf.js";import{al as w,$ as f,a1 as C,a0 as p,t as D,K as c,an as q,Z as Y,ag as Z,_ as K,ad as ie,M as N,aE as ke,am as G,ba as Se,L as Ae}from"../chunks/Bs3EBm-E.js";import{b as h,f as _,c as O,t as Ce}from"../chunks/D2Oxhlm5.js";import{a as x,f as Ie,e as de}from"../chunks/4YDsmxP6.js";import{e as U,i as P,b as Ee,s as ue,c as xe,d as Oe}from"../chunks/De1QSCgL.js";import{e as se}from"../chunks/Bx3wK1xy.js";import{c as oe}from"../chunks/BkLDZTjO.js";import{s as re,p as F}from"../chunks/CSD_HoJp.js";import{s as me}from"../chunks/NZYRv9zf.js";import{b as De,i as ee}from"../chunks/DJmFeHHs.js";import{c as Me}from"../chunks/Cw8iz2fq.js";import{h as z}from"../chunks/l0FKtB1Q.js";import{b as Le}from"../chunks/NnXymz2M.js";import"../chunks/tGppMfpQ.js";var he={},ae={},te=34,J=10,ne=13;function ge(n){return new Function("d","return {"+n.map(function(e,a){return JSON.stringify(e)+": d["+a+'] || ""'}).join(",")+"}")}function Be(n,e){var a=ge(n);return function(s,o){return e(a(s),o,n)}}function pe(n){var e=Object.create(null),a=[];return n.forEach(function(s){for(var o in s)o in e||a.push(e[o]=o)}),a}function E(n,e){var a=n+"",s=a.length;return s<e?new Array(e-s+1).join(0)+a:a}function je(n){return n<0?"-"+E(-n,6):n>9999?"+"+E(n,6):E(n,4)}function Fe(n){var e=n.getUTCHours(),a=n.getUTCMinutes(),s=n.getUTCSeconds(),o=n.getUTCMilliseconds();return isNaN(n)?"Invalid Date":je(n.getUTCFullYear())+"-"+E(n.getUTCMonth()+1,2)+"-"+E(n.getUTCDate(),2)+(o?"T"+E(e,2)+":"+E(a,2)+":"+E(s,2)+"."+E(o,3)+"Z":s?"T"+E(e,2)+":"+E(a,2)+":"+E(s,2)+"Z":a||e?"T"+E(e,2)+":"+E(a,2)+"Z":"")}function qe(n){var e=new RegExp('["'+n+`
\r]`),a=n.charCodeAt(0);function s(t,d){var T,b,m=o(t,function(A,v){if(T)return T(A,v-1);b=A,T=d?Be(A,d):ge(A)});return m.columns=b||[],m}function o(t,d){var T=[],b=t.length,m=0,A=0,v,k=b<=0,S=!1;t.charCodeAt(b-1)===J&&--b,t.charCodeAt(b-1)===ne&&--b;function j(){if(k)return ae;if(S)return S=!1,he;var H,W=m,I;if(t.charCodeAt(W)===te){for(;m++<b&&t.charCodeAt(m)!==te||t.charCodeAt(++m)===te;);return(H=m)>=b?k=!0:(I=t.charCodeAt(m++))===J?S=!0:I===ne&&(S=!0,t.charCodeAt(m)===J&&++m),t.slice(W+1,H-1).replace(/""/g,'"')}for(;m<b;){if((I=t.charCodeAt(H=m++))===J)S=!0;else if(I===ne)S=!0,t.charCodeAt(m)===J&&++m;else if(I!==a)continue;return t.slice(W,H)}return k=!0,t.slice(W,b)}for(;(v=j())!==ae;){for(var B=[];v!==he&&v!==ae;)B.push(v),v=j();d&&(B=d(B,A++))==null||T.push(B)}return T}function r(t,d){return t.map(function(T){return d.map(function(b){return i(T[b])}).join(n)})}function u(t,d){return d==null&&(d=pe(t)),[d.map(i).join(n)].concat(r(t,d)).join(`
`)}function g(t,d){return d==null&&(d=pe(t)),r(t,d).join(`
`)}function y(t){return t.map(l).join(`
`)}function l(t){return t.map(i).join(n)}function i(t){return t==null?"":t instanceof Date?Fe(t):e.test(t+="")?'"'+t.replace(/"/g,'""')+'"':t}return{parse:s,parseRows:o,format:u,formatBody:g,formatRows:y,formatRow:l,formatValue:i}}var Ne=qe(","),Ue=Ne.parse,Pe=_('<section id="demo-link"><h2>Link</h2> <p><a href="elements">Default element styles demo</a></p> <p><a href="fonts">Pudding-hosted font previews</a></p> <p><a href="ui">BitsUI styled components</a></p></section>');function Re(n){var e=Pe();h(n,e)}var Ge=_('<section id="demo-image"><h2>Image</h2> <p>img tag</p> <img src="../assets/demo/test.jpg" alt="cat" class="svelte-b56t42"/> <p>background image</p> <div class="svelte-b56t42"></div></section>');function He(n){var e=Ge();h(n,e)}var We=_('<section id="demo-element"><h2>Dynamic Svelte Element</h2> <!></section>');function ze(n){const e=[{tag:"h3",text:"I am a h3 tag."},{tag:"p",text:"I am p tag."}];var a=We(),s=w(f(a),2);U(s,17,()=>e,P,(o,r)=>{let u=()=>c(r).tag,g=()=>c(r).text;var y=O(),l=C(y);se(l,u,!1,(i,t)=>{var d=Ce();D(()=>x(d,g())),h(t,d)}),h(o,y)}),p(a),h(n,a)}var Ve=_("<p> </p>");function Je(n,e){var a=Ve(),s=f(a);p(a),D(()=>x(s,`I am component A and my favorite number is ${e.number??""}.`)),h(n,a)}var Ze=_("<p> </p>");function Ye(n,e){var a=Ze(),s=f(a);p(a),D(()=>x(s,`I am component B and my name is ${e.name??""}.`)),h(n,a)}var Ke=_('<section id="demo-component"><h2>Dynamic Svelte Component</h2> <!></section>');function Qe(n){const e={A:Je,B:Ye},a=[{component:"A",number:42},{component:"B",name:"Russell"}];var s=Ke(),o=w(f(s),2);U(o,17,()=>a,P,(r,u)=>{const g=q(()=>e[c(u).component]);var y=O(),l=C(y);oe(l,()=>c(g),(i,t)=>{t(i,re(()=>c(u)))}),h(r,y)}),p(s),h(n,s)}var Xe=_("<div><!></div>");function $e(n,e){Y(e,!0);let a=F(e,"root",3,null),s=F(e,"top",3,0),o=F(e,"bottom",3,0),r=F(e,"increments",3,100),u=F(e,"value",15,void 0),g=[],y=[],l=[],i=[],t;function d(){let v=0,k=0;for(let S=0;S<g.length;S++)g[S]>v&&(v=g[S],k=S);v>0?u(k):u(void 0)}function T(v,k){const S=R=>{R[0].isIntersecting;const Q=R[0].intersectionRatio;g[k]=Q,d()},j=s()?s()*-1:0,B=o()?o()*-1:0,H=`${j}px 0px ${B}px 0px`,W={root:a(),rootMargin:H,threshold:y};i[k]&&i[k].disconnect();const I=new IntersectionObserver(S,W);I.observe(v),i[k]=I}function b(){l.length&&l.forEach(T)}Z(()=>{for(let v=0;v<r()+1;v++)y.push(v/r());l=t.querySelectorAll(":scope > *:not(iframe)"),b()}),Z(()=>{s(),o(),b()});var m=Xe(),A=f(m);me(A,()=>e.children??ie),p(m),De(m,v=>t=v,()=>t),h(n,m),K()}var ea=_('<div><p class="svelte-1sxgmm9"> </p></div>'),aa=_('<section id="scrolly"><h2 class="svelte-1sxgmm9">Scrolly <span> </span></h2> <div class="spacer svelte-1sxgmm9"></div> <!> <div class="spacer svelte-1sxgmm9"></div></section>');function ta(n){let e=G(void 0);var a=aa(),s=f(a),o=w(f(s)),r=f(o,!0);p(o),p(s);var u=w(s,4);$e(u,{get value(){return c(e)},set value(g){N(e,g,!0)},children:(g,y)=>{var l=O(),i=C(l);U(i,16,()=>[0,1,2,3,4],P,(t,d,T)=>{const b=q(()=>c(e)===T);var m=ea();let A;var v=f(m),k=f(v,!0);p(v),p(m),D(()=>{A=Ee(m,1,"step svelte-1sxgmm9",null,A,{active:c(b)}),x(k,d)}),h(t,m)}),h(g,l)},$$slots:{default:!0}}),ke(2),p(a),D(()=>x(r,c(e)||"-")),h(n,a)}const na=`{
  "meta": {
...
}`;var sa=_("<p></p>"),oa=_('<details><summary></summary> <div class="content"><!></div></details>');function ra(n,e){let a=q(()=>typeof e.content=="string"),s=q(()=>e.open==="true");var o=oa(),r=f(o);z(r,()=>e.summary,!0),p(r);var u=w(r,2),g=f(u);{var y=i=>{var t=O(),d=C(t);z(d,()=>e.content),h(i,t)},l=i=>{var t=O(),d=C(t);U(d,17,()=>e.content,P,(T,b)=>{let m=()=>c(b).value;var A=sa();z(A,m,!0),p(A),h(T,A)}),h(i,t)};ee(g,i=>{c(a)?i(y):i(l,-1)})}p(u),p(o),D(()=>{o.open=c(s),ue(o,"name",e.name)}),h(n,o)}var ia=_("<li></li>"),la=_("<ul></ul>");function ca(n,e){var a=la();U(a,21,()=>e.li,P,(s,o)=>{var r=ia();z(r,()=>c(o),!0),p(r),h(s,r)}),p(a),h(n,a)}var da=_("<li></li>"),ha=_("<ol></ol>");function pa(n,e){var a=ha();U(a,21,()=>e.li,P,(s,o)=>{var r=da();z(r,()=>c(o),!0),p(r),h(s,r)}),p(a),h(n,a)}var ua=_("<p></p>"),ma=_("<section><!></section>");function ga(n,e){Y(e,!0);const a={details:ra,ul:ca,ol:pa};let s=F(e,"components",19,()=>({})),o=F(e,"body",19,()=>[]);var r=O(),u=C(r);U(u,17,o,P,(g,y)=>{let l=()=>c(y).section,i=()=>c(y).content;const t=q(()=>l().toLowerCase().replace(/[^a-z0-9]/g,"")),d=q(()=>s()[l()]);var T=ma(),b=f(T);{var m=v=>{var k=O(),S=C(k);oe(S,()=>c(d),(j,B)=>{B(j,re(i))}),h(v,k)},A=v=>{var k=O(),S=C(k);U(S,17,i,P,(j,B,H,W)=>{let I=()=>c(B).type,R=()=>c(B).value;const Q=q(()=>s()[I()]||a[I()]),ve=q(()=>typeof R()=="string");var le=O(),fe=C(le);{var ye=M=>{var L=O(),V=C(L);oe(V,()=>c(Q),(X,$)=>{$(X,re(R))}),h(M,L)},be=M=>{var L=ua();z(L,R,!0),p(L),h(M,L)},we=M=>{var L=O(),V=C(L);se(V,I,!1,(X,$)=>{var ce=O(),Te=C(ce);z(Te,R),h($,ce)}),h(M,L)},_e=M=>{var L=O(),V=C(L);se(V,I,!1,(X,$)=>{xe(X,()=>({...R()}))}),h(M,L)};ee(fe,M=>{c(Q)?M(ye):I()==="text"?M(be,1):c(ve)?M(we,2):M(_e,-1)})}h(j,le)}),h(v,k)};ee(b,v=>{c(d)?v(m):v(A,-1)})}p(T),D(()=>ue(T,"id",c(t))),h(g,T)}),h(n,r),K()}var va=_('<p> </p> <progress max="100"></progress>',1);function fa(n,e){let a=F(e,"label",3,"A"),s=F(e,"value",3,0);var o=va(),r=C(o),u=f(r,!0);p(r);var g=w(r,2);D(()=>{x(u,a()),Oe(g,s())}),h(n,o)}var ya=_('<section id="cms"><h2>MicroCMS</h2> <code><pre> </pre></code> <!></section>');function ba(n,e){Y(e,!0);const{body:a}=Me,s={Test:fa};var o=ya(),r=w(f(o),2),u=f(r),g=f(u,!0);p(u),p(r);var y=w(r,2);ga(y,{get components(){return s},get body(){return a}}),p(o),D(l=>x(g,l),[()=>na.replace(/\t/g," ")]),h(n,o),K()}const wa=(n,e=ie)=>{var a=_a(),s=f(a),o=f(s,!0);p(s);var r=w(s,2),u=f(r,!0);p(r),p(a),D(()=>{x(o,e().name),x(u,e().age)}),h(n,a)};var _a=_('<div class="person svelte-q3gttf"><p class="svelte-q3gttf"> </p> <p class="svelte-q3gttf"> </p></div>'),Ta=_('<h2>Svelte5</h2> <h3>Reactive variables 3 ways:</h3> <button class="svelte-q3gttf">count++</button> <p class="svelte-q3gttf"> </p> <p class="svelte-q3gttf"> </p> <p class="svelte-q3gttf"> </p> <h3>Children (previously slots):</h3> <div class="children"><!></div> <h3>Dispatch Event</h3> <button class="svelte-q3gttf">Random</button>  <h3>Snippets</h3> <div class="people svelte-q3gttf"></div>',1);function ka(n,e){Y(e,!0),F(e,"age",3,30);const a=[{name:"John",age:30},{name:"Jill",age:45}];let s=G(0),o=q(()=>c(s)*2),r=q(()=>c(s)*2),u=G(0);Z(()=>{N(u,c(s)*2)});var g=Ta(),y=w(C(g),4),l=w(y,2),i=f(l);p(l);var t=w(l,2),d=f(t);p(t);var T=w(t,2),b=f(T);p(T);var m=w(T,4),A=f(m);me(A,()=>e.children??ie),p(m);var v=w(m,4),k=w(v,4);U(k,21,()=>a,P,(S,j)=>{wa(S,()=>c(j))}),p(k),D(()=>{x(i,`${c(s)??""} doubled is ${c(o)??""} (derived)`),x(d,`${c(s)??""} doubled is ${c(r)??""} (derived by)`),x(b,`${c(s)??""} doubled is ${c(u)??""} ($effect)`)}),de("click",y,()=>Se(s)),de("click",v,()=>e.random(Math.floor(Math.random()*10))),h(n,g),K()}Ie(["click"]);const Sa=(n,e)=>{let a=G(Ae(n)),s=G(null),o=G(!0),r=G(void 0);const u=(l=!0)=>{N(o,l,!0),l===!0&&(N(r,null),N(s,null))},g=async()=>{try{const l=await fetch(c(a),e);if(!l.ok)throw new Error(`Unexpected error occurred (status ${l.status})`);let i;if(c(a).includes(".csv")){const t=await l.text();i=Ue(t)}else i=await l.json();return[null,i]}catch(l){const{errorMessage:i="Unexpected error eccurred"}=l;return[i,null]}},y=async l=>{u(!0);const[i,t]=await g();if(l===c(a)){if(i){u(!1),N(r,i,!0);return}u(!1),N(s,t,!0)}};return Z(()=>{y(c(a))}),{get data(){return c(s)},get loading(){return c(o)},get error(){return c(r)},get url(){return c(a)},set url(l){c(a)!==l&&N(a,l,!0)}}};var Aa=_("<p>loading data...</p>"),Ca=_("<p> </p>"),Ia=_("<p>data loaded</p> <pre> </pre>",1),Ea=_('<div class="c"><h2>Load Data</h2> <div class="response"><!></div></div>');function xa(n,e){Y(e,!0);const a=`${Le}/assets/demo/test.csv`,s=Sa(a);Z(()=>{});var o=Ea(),r=w(f(o),2),u=f(r);{var g=i=>{var t=Aa();h(i,t)},y=i=>{var t=Ca(),d=f(t);p(t),D(()=>x(d,`error: ${s.error??""}`)),h(i,t)},l=i=>{var t=Ia(),d=w(C(t),2),T=f(d,!0);p(d),D(b=>x(T,b),[()=>JSON.stringify(s.data,null,2)]),h(i,t)};ee(u,i=>{s.loading?i(g):s.error?i(y,1):i(l,-1)})}p(r),p(o),h(n,o),K()}var Oa=_('<div id="demo" class="svelte-15aotx7"><h1>Demo</h1> <!> <!> <!> <!> <!> <!> <!> <!></div>');function Da(n){let e=G(0);function a(d){console.log(d)}var s=Oa(),o=w(f(s),2);Re(o);var r=w(o,2);He(r);var u=w(r,2);ze(u);var g=w(u,2);Qe(g);var y=w(g,2);ba(y,{});var l=w(y,2);xa(l,{});var i=w(l,2);ta(i);var t=w(i,2);ka(t,{random:a,get value(){return c(e)},set value(d){N(e,d,!0)}}),p(s),h(n,s)}function Va(n){Da(n)}export{Va as component};
